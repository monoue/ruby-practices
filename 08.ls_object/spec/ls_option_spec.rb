...
RSpec.describe LsOption do # rubocop:disable Metrics/BlockLength
  describe 'reverse?' do # rubocop:disable Metrics/BlockLength
    context 'without command line arguments' do
      it 'returns false' do
        argv = []
        expect(LsOption.new(command_line_arguments: argv).reverse?).to be_falsy
      end
    end
    ...
    context 'when command line argument is "-r"' do
      it 'returns true' do
        argv = ['-r']
        expect(LsOption.new(command_line_arguments: argv).reverse?).to be_truthy
      end
    end
  ...
  describe 'all?' do # rubocop:disable Metrics/BlockLength
    context 'without command line arguments' do
      it 'returns false' do
        argv = []
        expect(LsOption.new(command_line_arguments: argv).all?).to be_falsy
      end
    end
    ...
    context 'when command line argument is "-a"' do
      it 'returns true' do
        argv = ['-a']
        expect(LsOption.new(command_line_arguments: argv).all?).to be_truthy
      end
    end
  ...
  describe 'long_format?' do # rubocop:disable Metrics/BlockLength
    context 'without command line arguments' do
      it 'returns false' do
        argv = []
        expect(LsOption.new(command_line_arguments: argv).long_format?).to be_falsy
      end
    end
    ...
    context 'when command line argument is "-l"' do
      it 'returns true' do
        argv = ['-l']
        expect(LsOption.new(command_line_arguments: argv).long_format?).to be_truthy
      end
    end
